...
namespace Feature.Fulfillment.Engine
{
    ...
    public class SaveFulfillmentFeeBook : PipelineBlock<SaveFulfillmentFeeBookArgument, FulfillmentFeeBook, CommercePipelineExecutionContext>
    {
        ...
        /// <returns></returns>
        public override async Task<FulfillmentFeeBook> Run(SaveFulfillmentFeeBookArgument arg, CommercePipelineExecutionContext context)
        {
            ...
            var fulfillmentOptionGroupList = 
                from df in arg.FulfillmentFees
                group df by new
                {
